...
(*implement just-in-time calculating of riemann*)
...
(* ::Text:: *)
(*Meant for internal use only, not for users.*)
...
(* ::Section::Closed:: *)
(*Usage of Indices & Tensor Wrapper Function*)
...
(*Access tensor data with T[[upList,downList]] where upList and downList are lists of integers of the same length as uprank and downrank*)
(*to do*)
...
(* ::Text:: *)
(*Functions meant for the user to use directly.*)
...
(* ::Subsection:: *)
(*Multiplication using Einstein Index Notation*)
...
\[CapitalGamma] = CalcChristoffel[Evaluate@T[manifold]];
